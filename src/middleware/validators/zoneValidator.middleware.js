...
exports.createZoneSchema = [
    ...
    body(`${ZoneModel.resourcesAlias}.*.type`)
        .trim()
        .exists()
    ...
    body(`${ZoneModel.disabledSeatsAlias}`)
        .optional()
        .isArray()
    ...
    body(`${ZoneModel.disabledSeatsAlias}.*.seat_number`)
        .exists()
        .withMessage('Seat number is required for each seat')
        .bail()
        .isInt()
        .withMessage('Should be an integer'),
    body(`${ZoneModel.disabledSeatsAlias}.*.seat_row`)
        .trim()
        .exists()
        ...
        .withMessage('Must be alphabetic')
        .toUpperCase(),
    body(`${ZoneModel.disabledSeatsAlias}.*.type`)
        .trim()
        .exists()
